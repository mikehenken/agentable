...
/**
 * HelperButtons slot — preserves default tldraw helper buttons and adds
 * the search bar when open (tldraw text-search example pattern).
 */
export const TextSearchPanel = track(function TextSearchPanel(
  props: TLUiHelperButtonsProps,
): ReactElement {
  return (
    <>
