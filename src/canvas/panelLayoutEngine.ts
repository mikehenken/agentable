...
function findStackBelowPosition(
  ...
  return snapPositionAvoidingOverlap(
    fallbackX,
    fallbackY,
    w,
    h,
...
/** Priority map — lower number = placed earlier in auto-organize flow. */

export const PANEL_ORGANIZE_PRIORITY: Record<string, number> = {
  chat: 0,
