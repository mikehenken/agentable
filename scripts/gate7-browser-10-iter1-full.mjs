/**
 * wave-3 — 10-locale-rtl browser verification (Playwright supplementary).
 */
...
const cacheBust = 'iter1-design-remediation-20260723b';
...
try {
  ...
  console.log(JSON.stringify({ pass: report.pass, captures: report.captures.length }, null, 2));
} finally {
  await browser.close;
}
