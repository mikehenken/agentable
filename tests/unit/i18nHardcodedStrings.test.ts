/**
 * AC teeth, the "CI grep": no hardcoded user-facing strings outside
...
function isStringLike(node: ts.Node): node is ts.StringLiteral | ts.NoSubstitutionTemplateLiteral | ts.TemplateExpression {
...
describe(' hardcoded user-facing strings gate', () => {
